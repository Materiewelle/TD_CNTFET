...
public:
    ...
    static constexpr double E_min = -1.2;         // from branching point at S/D
    static constexpr double E_max = +1.2;         // from branching point at S/D
    static constexpr double rel_tol = 8e-3;       // subdivide an interval as long as the relative deviation is larger
    static constexpr int initial_waypoints = 800; // divide into at least this number of smaller intervalls
