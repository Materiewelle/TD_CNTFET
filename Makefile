#############################################################################
# Makefile for building: circuit
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  circuit.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile circuit.pro
#############################################################################
...
CXXFLAGS      = -std=c++14 -march=native -fopenmp -g -Wall -W -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = circuit1.0.0
DISTDIR = /home/fabian/sw/local/.tmp/circuit1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lblas -lgomp -lsuperlu 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		util/system.hpp \
		signal.hpp \
		util/movie.hpp main.cpp
QMAKE_TARGET  = circuit
...
Makefile: circuit.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		circuit.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile circuit.pro
...
main.o: main.cpp charge_density.hpp \
		device_params.hpp \
		geometry.hpp \
		model.hpp \
		constant.hpp \
